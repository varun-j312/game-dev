...
class Game:
	...
	def load_data(self):
		...
		self.boost_sound = pg.mixer.Sound(path.join(self.snd_dir, 'Powerup5.wav'))
	...
	def update(self):
		...
		# check if player hit a platform - only if falling
	...
	def show_start_screen(self):
		...
		self.draw_text("Press a key to begin", 22, WHITE, WIDTH / 2, HEIGHT * 3 / 4)
